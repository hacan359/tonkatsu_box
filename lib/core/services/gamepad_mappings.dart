...
/// The `gamepads` package returns per-OS axis/button keys: Windows JOYINFOEX
/// (`dwXpos`, 0–65535); Linux/Android js-style (`abs-x`, -32767–32767).
abstract class GamepadMapping {
  ...
  static GamepadMapping forCurrentPlatform() {
    ...
    return const WindowsGamepadMapping();
  }
}
